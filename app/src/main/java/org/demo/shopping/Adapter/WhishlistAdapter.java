...
public class WhishlistAdapter  extends RecyclerView.Adapter<WhishlistAdapter.ViewHolder> {
    ...
    public WhishlistAdapter(List<ProductsCategory> apiResponseList, Context context,DeleteClicklistner deleteClicklistner) {
    ...
    @NonNull
    @Override
    public WhishlistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.cartandwhislistlayout, parent, false);
        return new WhishlistAdapter.ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull final WhishlistAdapter.ViewHolder holder, final int position) {
